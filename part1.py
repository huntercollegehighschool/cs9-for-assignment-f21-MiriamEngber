...
The program doesn't work quite right yet, though. Fix the program so that it runs the way it should (there should be at least 3 things you need to change.)
"""
